...
from sparse_attention import Encoder_Sparse
...
def main():
    ...
    # Using local window attention as an example (window_size=4)
    encoder = Encoder_Sparse(tokenizer.vocab_size, block_size, n_embd, n_layer, n_head, sparse_type="local", window_size=4, block_size_attn=4)
