...
def main():
    ...
    if args.task == 'part1':
        ...
        utils = Utilities(tokenizer, encoder, "results/encoder", "encoder_pre_training")
        ...
        utils = Utilities(tokenizer, encoder, "results/encoder", "encoder_post_training")
        test_sentence = "That's how progress happens -- in societies and in our own lives."
        utils.sanity_check(test_sentence, block_size)
        ...
        print("\nPRE TRAINING: Running Attention Sanity Check")
        utils = Utilities(tokenizer, decoder, "results/decoder", "decoder_pre_training")
        test_sentence = "That's how progress happens -- in societies and in our own lives."
        utils.sanity_check(test_sentence, block_size)
        ...
        print("\nPOST TRAINING: Running Attention Sanity Check")
        utils = Utilities(tokenizer, decoder, "results/decoder", "decoder_post_training")
        test_sentence = "That's how progress happens -- in societies and in our own lives."
        utils.sanity_check(test_sentence, block_size)
